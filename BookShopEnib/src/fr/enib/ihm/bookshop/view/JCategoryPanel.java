 ...
 * @author yo8chapa
 */
public class JCategoryPanel extends javax.swing.JPanel {

    /** Creates new form JCategoriePanel */
    public JCategoryPanel() {
        initComponents();
        enableSearch(false);
        jMainTable.setModel(Categories.getInstance());
    ...
    private void initComponents() {
        ...
        jLbLTitleNorth.setText("Categories");
        ...
        jTextSearch.setToolTipText("Search a category by name");
    ...
    private void jButtonCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonCreateMouseClicked
        JPanel createPanel = new JCreateCategoryPanel();
        JTabbedPane tabbedPane = (JTabbedPane) getParent();
        new JClosePanel("Create new category", tabbedPane, createPanel);
    ...
    private void jButtonDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonDeleteMouseClicked
        ...
        if (row >=0){
            Category category = Categories.getInstance().getCategoryAtRow(row);
            ApplicationEventsDispatcher.getApplicationEventsDispatcher().fireRemoveCategoryEvent(new CategoryEvent(evt, category));
        }
    ...
    private void jButtonUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonUpdateMouseClicked
        int row = jMainTable.getSelectedRow();
        if (row >=0){
            JPanel updatePanel = new JUpdateCategoryPanel(Categories.getInstance().getCategoryAtRow(row));
            JTabbedPane tabbedPane = (JTabbedPane) getParent();
            new JClosePanel("Update a category",tabbedPane, updatePanel);
    ...
    private void jButtonReadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonReadMouseClicked
        ...
        if (row >=0){
            ...
            JPanel readPanel = new JReadCategoryPanel(Categories.getInstance().getCategoryAtRow(row));
            JTabbedPane tabbedPane = (JTabbedPane) getParent();
            new JClosePanel("Read a category",tabbedPane, readPanel);
