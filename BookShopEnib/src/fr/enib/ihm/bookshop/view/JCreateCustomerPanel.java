 ...
 * @author yo8chapa
 */
public class JCreateCustomerPanel extends javax.swing.JPanel {

    /** Creates new form JCreateCustomerPanel */
    public JCreateCustomerPanel() {
        initComponents();
        // -- Calendars // BirthDate and credit card expiration
        calendarBirthDate = new JDateChooser("dd/MM/yyyy", "##/##/####", '_');
        calendarBirthDate.setDate(new Date());
    ...
    private void initComponents() {
        ...
        jLbLTitleNorth.setText("Add customer");
    ...
    private void jButtonCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonCreateMouseClicked
        if(verifyCustomerData() & verifyCustomerCard()){
            ...
            Customer newCustomer = new Customer( jTextLogin.getText(),  jTextFirstName.getText(),  jTextLastName.getText(),
                                                 jTextTelephone.getText(),  jTextMail.getText(),  customerAddress);
            newCustomer.setDateOfBirth(calendarBirthDate.getDate());
            newCustomer.setPassword(jTextPassword.getText());
            // -- Creditcard
            ...
            newCustomer.setCreditCard(customerCard);
               // -- Tirage d'évenement
               ApplicationEventsDispatcher.getApplicationEventsDispatcher().fireAddCustomerEvent(new CustomerEvent(evt, newCustomer));
   ...
   /// TODO private static final String telRegex = "([0-9]{2}-){4}[0-9]{2}";
}
