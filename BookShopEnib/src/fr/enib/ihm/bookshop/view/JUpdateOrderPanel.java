 ...
 * @author yo8chapa
 */
public class JUpdateOrderPanel extends javax.swing.JPanel {

    /** Creates new form JAddCustomerPanel */
    public JUpdateOrderPanel(Order order) {
        initComponents();
        /*
         * Initialisation
         */
        // -- Panel hidden
        setOrderToUpdated(order);
        ...
        if(order.getCreditCard().equals(order.getCustomer().getCreditCard())){
            ...
            jTextCardNumber2.setText(order.getCreditCard().getCreditCardNumber());
            jTextCardType2.setText(order.getCreditCard().getCreditCardType());
            SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
            try {
                calendarExpCardDate.setDate(formatter.parse(order.getCreditCard().getCreditCardExpDate()));
            } catch (ParseException ex) {
                Logger.getLogger(JUpdateOrderPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        // Address
    ...
    private void initComponents() {
        ...
        jPanelListOrderLineLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelListOrderLineLayout.createSequentialGroup()
                ...
                .addGroup(jPanelListOrderLineLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPaneOrders, javax.swing.GroupLayout.DEFAULT_SIZE, 219, Short.MAX_VALUE)
                    .addComponent(jButtonRemoveOrderLine, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanelListOrderLineLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelListOrderLineLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jScrollPaneOrders, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButtonCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonCreateMouseClicked
            ...
            if(check == true){
                ...
                order.setId(orderToUpdated.getId());
                // -- Tirage d'évenement
                ApplicationEventsDispatcher.getApplicationEventsDispatcher().fireUpdateOrderEvent(new OrderEvent(evt, order));
    ...
    private Order orderToUpdated;
    public void setOrderToUpdated(Order orderToUpdated) {
        this.orderToUpdated = orderToUpdated;
    }
}
